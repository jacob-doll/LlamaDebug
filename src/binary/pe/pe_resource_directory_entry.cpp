...
pe_resource_directory *pe_resource_directory_entry::directory() const
{
  return m_directory;
}

pe_resource_data_entry *pe_resource_directory_entry::data_entry() const
{
  return m_data_entry;
}
...
void pe_resource_directory_entry::directory(pe_resource_directory *directory)
{
  m_directory = directory;
}

void pe_resource_directory_entry::data_entry(pe_resource_data_entry *data_entry)
{
